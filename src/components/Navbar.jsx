...
import { logout, parseJwt, getUserId, getId } from "../web-services";
...
function Navbar() {
  ...
  const isUserLoggedIn = () => {
    if (token) {
      return (
        <>
          <div className="flex justify-end items-center align-middle bg-[#242934] h-12 px-14">
            <div>
              <button
              ...
              >
                <svg
                  ...
                  height="20"
                  viewBox="0 0 20 20"
                  className="inline mr-3 fill-white"
                >
                  <path d="M9.5 3.7c2 0 3.7 1.6 3.7 3.7S11.5 11 9.5 11 5.8 9.4 5.8 7.4s1.7-3.7 3.7-3.7zm0-3.7C14.7 0 19 4.3 19 9.5S14.7 19 9.5 19 0 14.7 0 9.5 4.3 0 9.5 0zm6.2 13.9c.9-1.3 1.4-2.8 1.4-4.4 0-4.2-3.4-7.7-7.7-7.7S1.8 5.3 1.8 9.5c0 1.7.5 3.2 1.4 4.4.9-1.2 2.4-2 4-2 .4 0 1 .4 2.2.4 1.2 0 1.8-.4 2.2-.4 1.8.1 3.2.8 4.1 2z"></path>
                </svg>
          ...
          <nav className="flex justify-start items-center text-[#242934] text-lg h-20 px-14 border-b-2 ">
            <svg
              width="46"
              height="49"
              viewBox="0 0 46 49"
            ...
            <span className="block border h-12 mr-4 border-[#dee3e5]"></span>
            <svg
              width="120"
              height="42"
              viewBox="0 0 120 42"
      ...
      return (
        <div className="flex justify-end items-center bg-[#242934] h-12 px-14">
          <button
  ...
  return <header className="text-white">{isUserLoggedIn()}</header>;
}
